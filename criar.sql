...
CREATE TABLE Assinatura(
    nif TEXT REFERENCES Cliente ON DELETE CASCADE 
                                ON UPDATE CASCADE,
...
CREATE TABLE Informacao(
    nomeEstacao TEXT REFERENCES Estacao ON DELETE CASCADE 
                                        ON UPDATE CASCADE,
...
CREATE TABLE Maquinista(
    nifMaquinista TEXT REFERENCES Trabalhador(nif)  ON DELETE CASCADE 
                                                    ON UPDATE CASCADE,
    numLicensa TEXT,
...
CREATE TABLE Bilheteiro(
    nifBilheteiro TEXT REFERENCES Trabalhador(nif)  ON DELETE CASCADE 
                                                    ON UPDATE CASCADE,
...
CREATE TABLE Revisor(
    nifRevisor TEXT REFERENCES Trabalhador(nif) ON DELETE CASCADE 
                                                ON UPDATE CASCADE,
...
CREATE TABLE Viagem1(
    ...
    idComboio INTEGER REFERENCES Comboio    ON DELETE CASCADE 
                                            ON UPDATE CASCADE,

    idRota INTEGER REFERENCES Rota  ON DELETE CASCADE 
                                    ON UPDATE CASCADE,

    nifMaquinista REFERENCES Maquinista ON DELETE CASCADE 
                                        ON UPDATE CASCADE
);
...
CREATE TABLE RevisorViagem(
    nifRevisor TEXT REFERENCES Revisor  ON DELETE CASCADE 
                                        ON UPDATE CASCADE,

    idViagem INTEGER REFERENCES Viagem  ON DELETE CASCADE 
                                        ON UPDATE CASCADE,
...
CREATE TABLE Bilhete1(
    ...
    CHECK(nomeEstacaoChegada != nomeEstacaoPartida)
);
